...
title servermonitorDM.bat
:start
C:\Windows\System32\tasklist /FI "IMAGENAME eq DayZServerDM_x64.exe" 2>NUL | C:\Windows\System32\find /I /N "DayZServerDM_x64.exe">NUL
if "%ERRORLEVEL%"=="0" goto loop
echo Server is not running, will be started now 
start "" /min /wait "E:\DayZServerDeathMatch\restartserverDM.bat - Shortcut" 
timeout 30
